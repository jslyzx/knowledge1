<template>
  <div class="container">
        ...
        <div class="table-wrap">
          ...
          <table cellspacing="0" style="margin-top: 30px;">
            ...
            <tr>
              ...
              <td colspan="2">
                <span class="label">二保方案</span>
                <span class="con">更换设备零件</span>
              </td>
            </tr>
          </table>
        </div>
    ...
    <div class="part switchBg">
      <div class="part-title switchText">二保计划内容</div>
...
<script>
import { getEbList } from '@/api/device'
...
export default {
  ...
  methods: {
    fetchList() {
      ...
      getEbList(this.listQuery).then(response => {
